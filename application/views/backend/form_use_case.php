  ...
  <div class="box col-md-12">
    <div class="box-inner">
      <div class="well" data-original-title="">
        <h2><i class="glyphicon glyphicon-edit"></i> Form Use Case  <?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?> </h2>
        <!--
          <div class="box-icon">
	...
	<div class="alert alert-danger">
		...
		<!--
          ...
          <div class="form-group">
            ...
            <input type="text"  name="transaksi" class="form-control" id="text" value="<?php if(isset($transaksi)) echo $transaksi; ?>"   placeholder="Masukkan transaksi" style="width:400px" >
			<?php if(isset($errtransaksi)){ echo'<p><font color="red">transaksi belum diisi</font></p>'; }?>
		  </div>
		   <div class="form-group">
