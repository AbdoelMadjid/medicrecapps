...
<?php echo $content; ?>
    ...
    <div class="row">
        <div class="col-md-9 col-lg-9 col-xs-9  hidden-xs">
            <script async src="<?php echo base_url(); ?>//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
            <!-- Charisma Demo 2 -->
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="<?php echo base_url(); ?>http://usman.it" target="_blank">Muhammad
                Usman and Faiz Fanani</a> 2012 - 2014</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a
                href="<?php echo base_url(); ?>http://usman.it/free-responsive-admin-template">Charisma</a></p>
    </footer>
