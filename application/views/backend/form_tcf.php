  ...
  <div class="box col-md-12">
    <div class="box-inner">
      <div class="well" data-original-title="">
        <h2><i class="glyphicon glyphicon-edit"></i> Form Indikator Kompleksitas Faktor Teknis(TCF)<?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?> </h2>
        <!--
          <div class="box-icon">
        ...
        <form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url().$urlAction ; ?>" >
		 ...
		 -->
          <div class="form-group">
			...
			<?php if(isset($errdeskripsi)){ echo'<p><font color="red">Masukan deskripsi Indikator</font></p>'; }?>
		  </div>
		   <div class="form-group">
