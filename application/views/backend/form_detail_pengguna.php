  ...
  <div class="box col-md-12">
    <div class="box-inner">
      <div class="well" data-original-title="">
        <h2><i class="glyphicon glyphicon-edit"></i> Detail Request Pengguna  <?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?> </h2>
        <!--
          <div class="box-icon">
	  ...
	  <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama_lengkap" class="form-control" readonly id="text" value="<?php if(isset($nama_lengkap)) echo $nama_lengkap; ?>"   placeholder="Masukkan Nama lengkap" style="width:400px" >
		 ...
		 <div class="form-group">
            ...
            <input type="text" name="nama_panggilan"class="form-control" readonly id="text" value="<?php if(isset($nama_panggilan)) echo $nama_panggilan; ?>"   placeholder="Masukkan Nama Paggilan " style="width:400px" >
		   ...
		   <div class="form-group">
            ...
            <textarea name="alamat"class="form-control" readonly id="text"   placeholder="Masukkan Alamat " style="width:400px" ><?php if(isset($alamat)) echo $alamat; ?></textarea>
		 ...
		 <div class="form-group">
            ...
            <input type="text" name="email"class="form-control" readonly id="text" value="<?php if(isset($email)) echo $email; ?>"   placeholder="Masukkan Email Pengguna" style="width:400px" >
		  ...
		  <div class="form-group">
            ...
            <input type="text"  name="kewarganegaraan" class="form-control" readonly id="text" value="<?php if(isset($kewarganegaraan)) echo $kewarganegaraan; ?>"   placeholder="Masukkan Kewarganegaraan" style="width:400px" >
          ...
          <div class="form-group">
            ...
            <input type="text"  name="username" class="form-control" readonly id="text" value="<?php if(isset($username)) echo $username; ?>"   placeholder="Masukkan Username" style="width:400px" >
          ...
          <?php if(isset($edit)){
            ...
            <div class="form-group">
                              ...
                              <input type="password" name="recpassword" class="form-control" readonly id="exampleInputPassword1" placeholder="Password" style="width:400px">
          ...
          <div class="form-group">
            ...
            <input type="password" name="password" class="form-control" readonly id="exampleInputPassword1" placeholder="Password" style="width:400px">
