...
function makeAjaxCall(){
	...
	$.ajax({
		type: "post",
		url: "http://localhost/ucpappsta/estimasi/add_tcf",
		cache: false,				
		data: $('#tcf').serialize(),
    ...
    <div class="box-inner">
      ...
      <div class="box-content">
                ...
                <ul class="nav nav-tabs" id="myTab2">
                    ...
                    <li class="active" ><a href="#info"  >Technical Complexity Factor (TCF)</a></li>
		...
		<tr>
				...
				<label class="radio-inline">
                    <input type="radio" name="s urveytcf<?php echo $n;?>" id="inlineRadio2" value="4"> 4
                </label>
				<label class="radio-inline">
				...
				<a class="btn btn-info"   onclick="return confirm('Anda Yakin?. Pastikan semua Indikator diisi')"  style="float: right;"  href="http://localhost/ucpappsta/estimasi/form_ecf"> 
