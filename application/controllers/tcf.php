...
class Tcf extends CI_Controller
	...
	public function index()
		{
		redirect('tcf/daftar_tcf');
		}

	// fungsi ini digunkan untuk menampilkan daftar uc

	public function daftar_tcf()
		{
		...
		$data['content'] = $this->load->view('backend/daftar_tcf', $isi);
